...
Func Check_clear_cargo()
   Dim $cargo[6] = [329,47,329,250,370,421]
   $color_1 = 0x000000
   ;$color_2 = 0x010101
   ;$color_3 = 0x020202
   ;$color_4 = 0x020101
   ;$color_5 = 0x020201
   $state = 0 ;;;По умолчанию считаем, что в карго не пустое
   ...
   if  IsArray($z1) And IsArray($z2) And IsArray($z3) Then
	  $state = 1 ;;;В карго руды не нашли
   EndIf
   Return $state
EndFunc
